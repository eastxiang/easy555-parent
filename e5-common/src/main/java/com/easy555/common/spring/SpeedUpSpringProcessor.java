 ...
 */
package com.easy555.common.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.easy555.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
    ...
    public static void main(String[] args) {
        String c = "com.easy555.uc.dao.user.web.bind.A";
